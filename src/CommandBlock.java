...
public  class CommandBlock {
	 ...
	 */
	public CommandBlock(JComponent parent, Color primary, Color secondary, Command command) {
		this.parent = parent;
		primCol = primary;
		secCol = secondary;
	 ...
	 * @param command		Custom command to run
	 */
	public CommandBlock(JComponent parent, int x, int y, Color primary, Color secondary, Command command) {
		this.parent = parent;
